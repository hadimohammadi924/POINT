...
public class finalcust extends AppCompatActivity {
...
Double z1,z2,z3,z4;
    ...
    public void getcust(String pgcode) {
        RequestQueue requestQueue;
        Cache cache = new DiskBasedCache(getCacheDir(), 1024 * 1024); // 1MB cap
        Network network = new BasicNetwork(new HurlStack());
        requestQueue = new RequestQueue(cache, network);
        requestQueue.start();
        String url = "https://pgtab.info/home/getcustwithcode?pgcode="+getIntent().getStringExtra("pgcodee")  ;
    ...
    public void getbazar(String pgcode) {
        ...
        requestQueuee.start();
        String url2 = "https://pgtab.info/home/getalll_bazargardiwithcodeee?bcode="+getIntent().getStringExtra("pgcodee")  ;
             ...
             */
                    ...
                    public void onResponse(String bresponsee) {
                        ...
                        try {
                            ...
                            Glide.with(finalcust.this).load(respob.getString("byakhurl")).apply(options).into(bfimageveiw);
    ...
    public void getdata(String pdcode) {
        ...
        String url3 = "https://pgtab.info/home/getaldatawithcode?pdcode="+getIntent().getStringExtra("pgcodee")  ;
    ...
    public void gettiket2(String pdcode) {


        String url88 = "https://pgtab.info/home/getaltikettwithcode?tbgcode="+getIntent().getStringExtra("pgcodee")  ;
    ...
    public void getvy(String pgcode) {
        ...
        requestQueuee = new RequestQueue(cache, network);
        requestQueuee.start();
        String url2 = "https://pgtab.info/home/getvy?c_code="+getIntent().getStringExtra("pgcodee")  ;
             ...
             */
                    ...
                    public void onResponse(String bresponsee) {
                        ...
                        try {
                            ...
                            Glide.with(finalcust.this).load(respobt.getString("url")).apply(options).into(bfimageveiww);
    ...
    public void setUpRecyclerView2(String responsee){
        LinearLayoutManager layout = new LinearLayoutManager(finalcust.this, LinearLayoutManager.VERTICAL, false);
        ticketsListRecyclerView2.setLayoutManager(layout);

        shekayatadapter shadpter = new shekayatadapter(createlist2(responsee),finalcust.this);
    ...
    public void onBackPressed() {
        startActivity(new Intent(finalcust.this, showcustpoint.class));
    }
